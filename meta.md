...
This repository owns skill definitions, the Claude Code agent definitions that preload them, the standards that govern both, and the tooling that validates and installs them.
